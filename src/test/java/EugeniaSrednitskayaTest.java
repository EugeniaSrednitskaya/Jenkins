...
public class EugeniaSrednitskayaTest extends BaseTest {
    ...
    @Test(priority = 2)
    public void ESBrowseLanguageLetterMTest() {
    ...
    @Test(priority = 3)
    public void ESBrowseLanguageColumnsNamesTest() {
    ...
    @Test(priority = 4)
    public void ESBrowseLanguageAuthorLanguageTest() {
    ...
    @Test(priority = 5)
    public void ESBrowseLanguagesDigitFirstLetterTest() {
    ...
    @Test(dependsOnMethods = "ESBrowseLanguagesDigitFirstLetterTest")
    public void ESBrowseLanguagesCountDigitFirstLetterTest() {
    ...
    @Test(priority = 7)
    public void ESSignGuestbookDisplayedTest() {
    ...
    @Test(priority = 9)
    public void ESTopListTwentyTest() {
    ...
    @Test(priority = 13)
    public void ESCountVersionJavaTest() throws InterruptedException {
    ...
    @Test(priority = 14)
    public void ESCommentsJavaTest() {
    ...
    @Test(priority = 15)
    public void ESBrowseLanguagesAlternativeVersionTest() throws InterruptedException {
